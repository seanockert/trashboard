/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3034b1a8bad0f7cccb64ee811a38ee85)
// Runtime types generated with workerd@1.20260921.1 2026-09-01 nodejs_compat
interface __BaseEnv_Env {
	RAW: R2Bucket;
	trashboard_raw: R2Bucket;
	DB: D1Database;
	trashboard: D1Database;
	INGEST_QUEUE: Queue;
	ITEM_QUEUE: Queue;
	AI: Ai;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TYPESAFE_API_KEY" | "DASHBOARD_PASSWORD" | "SESSION_SECRET">> {}
}
